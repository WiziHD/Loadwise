...
engine/     Das Regelmodul. Reine Funktionen, kein Framework, keine Datenbank,
            keine Oberfläche. 385 Motortests. Die Wahrheit über das, was das Produkt sagt.
...
```bash
npm install
npm run check      # Motor: Typen, 385 Motortests, Abdeckungsschwellen
                   # App:   182 Webtests (rein + Bauteile), Typen, Wortlaut-Grenze
